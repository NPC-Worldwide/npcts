import type { ImageryProvider } from "../types/imagery.js";
import { GibsProvider } from "./GibsProvider.js";
...
export const modalImageryProviders = imageryProviders.filter(
  (provider) => !provider.overlayOnly,
);
